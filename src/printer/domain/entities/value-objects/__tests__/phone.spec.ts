import { PhoneDomainValidationException } from '@printer/domain/exceptions';
...
describe('Phone Value Object', () => {
  ...
  it('should throw an InvalidParamException if DDD is not a number between 11 and 99', () => {
    expect(() => Phone.create(10, 999999999)).toThrow(PhoneDomainValidationException);
  });

  it('should throw an InvalidParamException if phone number has less than 8 digits', () => {
    expect(() => Phone.create(71, 9999999)).toThrow(PhoneDomainValidationException);
  });

  it('should throw an InvalidParamException if phone number has more than 9 digits', () => {
    expect(() => Phone.create(71, 9999999999)).toThrow(PhoneDomainValidationException);
  });

  it('should throw an InvalidParamException if cell phone does not starts with 9', () => {
    expect(() => Phone.create(71, 899999999)).toThrow(PhoneDomainValidationException);
  });

  it('should throw an InvalidParamException if fixed phone starts with 9', () => {
    expect(() => Phone.create(71, 99999999)).toThrow(PhoneDomainValidationException);
  });
});
